      ...
      <main className="flex-1">
        <section id="about" className="w-full py-12 md:py-24 lg:py-32">
          <div
            ...
            <div className="space-y-4">
              <div id="about" className="inline-block rounded-lg bg-muted px-3 py-1 text-sm">About Me</div>
        ...
        <section id="projects" className="w-full py-12 md:py-24 lg:py-32 bg-muted">
          <div
            className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
            <div className="space-y-4">
              <div id="projects" className="inline-block rounded-lg bg-muted px-3 py-1 text-sm">My Projects</div>
            ...
            <div className="grid gap-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>A Java Todo App is a beginner-friendly project that helps users manage tasks. It allows you to add tasks with descriptions and due dates, mark tasks as completed, and delete tasks. This project teaches fundamental Java skills like handling user input and organizing data efficiently. It's a practical way to improve coding abilities while creating a useful tool for everyday task management.</CardDescription>
                </CardHeader>
                <CardContent>
                  <img
                    src="/placeholder.svg"
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>I've developed a simple Phone Book app using vanilla JavaScript. It allows users to add contacts with names and phone numbers, which are displayed in a list format on the webpage. The app also features a delete function for removing contacts. This project enhanced my understanding of JavaScript's ability to manipulate the DOM and manage data dynamically.</CardDescription>
                </CardHeader>
                <CardContent>
                  <img
                    src="/placeholder.svg"
        ...
        <section id="contact" className="w-full py-12 md:py-24 lg:py-32">
          <div
            className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
            <div className="space-y-4">
              <div id="contact" className="inline-block rounded-lg bg-muted px-3 py-1 text-sm">Contact Me</div>
